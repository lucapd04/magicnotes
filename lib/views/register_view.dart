...
import 'package:magicnotes/constants/routes.dart';
import 'package:magicnotes/utilities/show_error_dialog.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          TextButton(onPressed: () {Navigator.of(context).pushNamedAndRemoveUntil(loginRoute, (route) => false);}, 
